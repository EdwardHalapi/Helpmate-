...
const VolunteerProfileForm = () => {
  ...
  // Get project ID from state if it exists
  ...
  const applyToProject = async (projectId) => {
    try {
      ...
      await updateDoc(volunteerRef, {
        pending: [...(formData.pending || []), projectId]
      });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // If we came from a project application, handle that
      if (projectId) {
        try {
          ...
          console.error('Error applying to project:', error);
          setError('Profilul a fost salvat, dar nu s-a putut aplica la proiect. Te rugăm să încerci din nou.');
          return;
        }
      } else {
