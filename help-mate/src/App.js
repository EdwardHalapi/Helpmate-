...
const OrganizerDashboard = () => (
  <PlaceholderPage pageName="Dashboard Organizator" />
);
const ProfileScreen = () => <PlaceholderPage pageName="Profil Utilizator" />;
const CreateProjectScreen = () => (
  <PlaceholderPage pageName="Creează Proiect" />
);
...
const PrivacyScreen = () => (
  <PlaceholderPage pageName="Politica de Confidențialitate" />
);
const NotFoundScreen = () => (
  ...
  >
    <h1 className="text-h1" style={{ fontSize: "6rem", margin: 0 }}>
      404
    </h1>
      ...
      <div className="App">
        <Routes>
          ...
          <Route
            ...
            element={<PlaceholderPage pageName="Resetare Parolă" />}
          />
          ...
          <Route
            ...
            element={<PlaceholderPage pageName="Istoric Voluntariat" />}
          />
          <Route
            path="/dashboard/voluntar/certificare"
            element={<PlaceholderPage pageName="Certificări" />}
          />
          ...
          <Route
            ...
            element={<PlaceholderPage pageName="Proiectele Mele" />}
          />
          <Route
          ...
          <Route
            ...
            element={<PlaceholderPage pageName="Gestionare Voluntari" />}
          />
          <Route
            path="/dashboard/organizator/rapoarte"
            element={<PlaceholderPage pageName="Rapoarte" />}
          />
          <Route
            path="/dashboard/organizator/organizatie"
            element={<PlaceholderPage pageName="Setări Organizație" />}
          />
          ...
          <Route
            path="/profil/edit"
            element={<PlaceholderPage pageName="Editare Profil" />}
          />
          ...
          <Route
            ...
            element={<PlaceholderPage pageName="Cum Funcționează" />}
          />
          <Route
            path="/comunitate"
            element={<PlaceholderPage pageName="Comunitate" />}
          />
          <Route path="/blog" element={<PlaceholderPage pageName="Blog" />} />
          <Route
            path="/success-stories"
            element={<PlaceholderPage pageName="Povești de Succes" />}
          />
          ...
          <Route
            path="/cookies"
            element={<PlaceholderPage pageName="Politica Cookies" />}
          />

          {/* Admin Routes (pentru viitor) */}
          <Route
            path="/admin"
            element={<PlaceholderPage pageName="Admin Dashboard" />}
          />
          <Route
            path="/admin/utilizatori"
            element={<PlaceholderPage pageName="Gestionare Utilizatori" />}
          />
          <Route
            path="/admin/organizatii"
            element={<PlaceholderPage pageName="Gestionare Organizații" />}
          />
          <Route
            path="/admin/proiecte"
            element={<PlaceholderPage pageName="Moderare Proiecte" />}
          />
          <Route
            path="/admin/rapoarte"
            element={<PlaceholderPage pageName="Rapoarte Admin" />}
          />
          <Route
            path="/admin/setari"
            element={<PlaceholderPage pageName="Setări Sistem" />}
          />
          ...
          <Route
            path="/dashboard"
            element={
              <PlaceholderPage pageName="Selectează tipul de dashboard" />
            }
          />
